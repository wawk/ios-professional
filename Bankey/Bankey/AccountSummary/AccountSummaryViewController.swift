...
//  Bankey
//
//  Created by Steve Moody on 6/13/23.
//
...
extension AccountSummaryViewController {
    ...
    private func setupTableView() {
        ...
        tableView.register(AccountSummaryCell.self, forCellReuseIdentifier:
                            AccountSummaryCell.reuseID)
...
extension AccountSummaryViewController {
    private func fetchData() {
        let savings = AccountSummaryCell.ViewModel(accountType: .Banking, accountName: "Basic Saving")
